    ...
    <div className="flex min-h-screen items-center justify-center px-4">
      <div className="glass max-w-md rounded-2xl p-10 text-center">
        ...
        <p className="mt-2 text-sm text-muted-foreground">
          This route isn't part of the VaultAI perimeter.
        </p>
        <div className="mt-6">
          <Link
            to="/"
  ...
  return (
    <div className="flex min-h-screen items-center justify-center px-4">
      <div className="glass max-w-md rounded-2xl p-10 text-center">
        ...
        <p className="mt-2 text-sm text-muted-foreground">
          VaultAI hit an unexpected condition. You can retry safely.
        </p>
        <div className="mt-6 flex flex-wrap justify-center gap-2">
          ...
          <a
            href="/"
            className="inline-flex items-center justify-center rounded-md border border-input bg-background/40 px-4 py-2 text-sm font-medium transition-colors hover:bg-accent/20"
          >
            Home
          </a>
        </div>
...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "VaultAI — Post-Breach Security Co-Pilot" },
      {
        name: "description",
        content:
      ...
      { name: "author", content: "VaultAI" },
      { property: "og:title", content: "VaultAI — Post-Breach Security Co-Pilot" },
      {
